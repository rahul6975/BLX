...
public class LoginActivity extends AppCompatActivity {
    private Button btnWithPhone, btnContinueWithGoogle, btnContinueWithFb;
    ...
    private void initViews() {
        ...
        btnContinueWithFb = findViewById(R.id.btnContinueWithFacebook);
        ...
        btnContinueWithFb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toasty.info(LoginActivity.this, "Feature Coming Soon! Hold Tight.", Toast.LENGTH_SHORT).show();
