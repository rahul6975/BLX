...
public class MetadataKolkataClasses implements Serializable {
	...
	private ModifiedFiltersKolkataClasses modifiedFilters;
	...
	public ModifiedFiltersKolkataClasses getModifiedFilters(){
