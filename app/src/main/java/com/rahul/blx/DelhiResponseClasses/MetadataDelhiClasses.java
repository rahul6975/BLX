package com.rahul.blx.DelhiResponseClasses;
...
public class MetadataDelhiClasses implements Serializable {
	...
	private ModifiedFiltersDelhiClasses modifiedFilters;
	...
	public ModifiedFiltersDelhiClasses getModifiedFilters(){
